...
public abstract class RoomSummaryAdapter extends BaseExpandableListAdapter {
    ...
    public boolean resetUnreadCount(int section, String roomId) {
        ...
        if (null != roomSummary) {
            ...
            // FIXME SACES res |= roomSummary.setHighlighted(false);
        }
    ...
    public boolean resetUnreadCounts(int section) {
        ...
        for(RoomSummary summary : summaries) {
            ...
            // FIXME SACES res |= summary.setHighlighted(false);
        }
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        View spinner = null;
        if (null != convertView) {
            // FIXME SACES spinner = convertView.findViewById(R.id.progressbar_waiting_room_members);
        }

        // assume that some public rooms are defined
        if (isPublicsGroupIndex(groupPosition) && (null == mPublicRoomsLists)) {
            if (null == spinner) {
                // FIXME SACES convertView = mLayoutInflater.inflate(R.layout.adapter_item_waiting_room_members, parent, false);
            }
            return convertView;
        }
        ...
        try {
            ...
            final View deleteProgress = convertView.findViewById(0); // FIXME SACES R.id.roomSummaryAdapter_delete_progress);
            ...
            if (isRecentsGroupIndex(groupPosition)) {
                ...
                TextView textView = (TextView) convertView.findViewById(0); // FIXME SACES R.id.roomSummaryAdapter_roomName);
                ...
                // FIXME SACES textView = (TextView) convertView.findViewById(R.id.roomSummaryAdapter_message);
                textView.setText(message);
                textView.setTextColor(textColor);
                // FIXME SACES textView = (TextView) convertView.findViewById(R.id.roomSummaryAdapter_ts);
                ...
                if (null == publicRoomsList) {
                    ...
                    if (publicRoom.numJoinedMembers > 1) {
                        textView.setText(publicRoom.numJoinedMembers + " " + mContext.getString(org.matrix.console.R.string.users));
                    } else {
                        textView.setText(publicRoom.numJoinedMembers + " " + mContext.getString(org.matrix.console.R.string.user));
                    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        TextView heading = (TextView) convertView.findViewById(0); // FIXME SACES R.id.heading);
        ...
        // FIXME SACES ImageView imageView = (ImageView) convertView.findViewById(R.id.heading_image);

        if (isExpanded) {
            // FIXME SACES imageView.setImageResource(R.drawable.expander_close_holo_light);
        } else {
            // FIXME SACes imageView.setImageResource(R.drawable.expander_open_holo_light);
        }
